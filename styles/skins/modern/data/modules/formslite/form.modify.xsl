...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/result[@method = 'template_edit' or @method = 'template_add']/data[@type = 'form' and (@action = 'modify' or @action = 'create')]">
...
&lt;/xsl:stylesheet&gt;</code></pre>
            ...
            <p>Здесь нужно ввести следующие данные:</p>
            	...
            	Для привязке шаблонна к форме, в форме должна быть такая строка
