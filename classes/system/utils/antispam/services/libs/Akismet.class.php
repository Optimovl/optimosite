<?php
	...
	class Akismet {
		 ...
		 *    Tests for spam.
		 *
		 *    Uses the web service provided by {@link http://www.akismet.com Akismet} to see whether or not the submitted comment is
		 * spam.  Returns a boolean value.
		 *
		 ...
		 *
		 *    Using this function will make you a good citizen as it helps Akismet to learn from its mistakes.  This will improve the
	 ...
	 *
	 *  This class is used by Akismet to do the actual sending and receiving of data.  It opens a connection to a remote host, sends
	 * some data and the reads the response and makes it available to the calling program.
	 *
	 ...
	 *
	 *    N.B. It is not necessary to call this class directly to use the Akismet class.  This is included here mainly out of a sense
	 * of completeness.
	 *
	 * @package    akismet
	...
	class SocketWriteRead {
		...
		public function send() {
			...
			if ($this->errorNumber != 0) {
				throw new Exception(
					'Error connecting to host: ' . $this->host . ' Error number: ' . $this->errorNumber . ' Error message: ' .
					$this->errorString
				);
			}
