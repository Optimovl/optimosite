<?php
	namespace UmiCms\System\Trade\Offer\Price\Attribute;

	use UmiCms\System\Orm\Entity\iAccessor;
	use UmiCms\System\Orm\Entity\Attribute\Accessor as AbstractAccessor;

	/**
	 * Класс аксессора атрибутов цены торгового предложения
	 * @package UmiCms\System\Trade\Offer\Price\Attribute
	 */
